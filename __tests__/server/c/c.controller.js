...
var c_middleware_1 = require("../middlewares/c.middleware");
var CController = /** @class */ (function () {
    function CController() {
    }
    CController.prototype.getControllerMiddlewareA = function (value) {
    ...
    CController.prototype.getControllerMiddlewareB = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, value];
            });
    ...
    ], CController.prototype, "getControllerMiddlewareA");
    __decorate([
        (0, method_decorator_1.Post)('/'),
        __param(0, (0, argument_decorator_1.Body)('value'))
    ], CController.prototype, "getControllerMiddlewareB");
